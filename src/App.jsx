      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{ color: C.muted, fontWeight: 600, fontSize: '0.9rem', lineHeight: 1.65, marginBottom: '1rem' }}>
            You will find me on Rover if you prefer to use an app. But booking directly through this site works just as well. I hold my own <a href="https://www.petbusinessinsurance.co.uk/public-liability.aspx" target="_blank" rel="noopener noreferrer" style={{color: C.text, textDecoration: 'underline', textUnderlineOffset: '3px'}}>dedicated pet care insurance</a> which covers every booking regardless of how you find me. Rover's Guarantee is a useful safety net but it is not a regulated insurance policy and has some limitations worth knowing about. Either way, your pet is covered. Booking direct also means no platform fees on either side.
          </p>
